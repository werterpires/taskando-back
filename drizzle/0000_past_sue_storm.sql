...
ALTER TABLE "audit_events" ADD CONSTRAINT "audit_events_personal_space_id_personal_spaces_id_fk" FOREIGN KEY ("personal_space_id") REFERENCES "public"."personal_spaces"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "cyclic_queue_overrides" ADD CONSTRAINT "cyclic_queue_overrides_task_id_tasks_id_fk" FOREIGN KEY ("task_id") REFERENCES "public"."tasks"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "cyclic_queue_overrides" ADD CONSTRAINT "cyclic_queue_overrides_personal_space_id_personal_spaces_id_fk" FOREIGN KEY ("personal_space_id") REFERENCES "public"."personal_spaces"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "cyclic_queue_overrides" ADD CONSTRAINT "cyclic_queue_overrides_created_by_user_id_users_id_fk" FOREIGN KEY ("created_by_user_id") REFERENCES "public"."users"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "cyclic_queue_states" ADD CONSTRAINT "cyclic_queue_states_personal_space_id_personal_spaces_id_fk" FOREIGN KEY ("personal_space_id") REFERENCES "public"."personal_spaces"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "departments" ADD CONSTRAINT "departments_owner_user_id_users_id_fk" FOREIGN KEY ("owner_user_id") REFERENCES "public"."users"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "fronts" ADD CONSTRAINT "fronts_project_id_projects_id_fk" FOREIGN KEY ("project_id") REFERENCES "public"."projects"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "fronts" ADD CONSTRAINT "fronts_personal_space_id_personal_spaces_id_fk" FOREIGN KEY ("personal_space_id") REFERENCES "public"."personal_spaces"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "fronts" ADD CONSTRAINT "fronts_organization_id_organizations_id_fk" FOREIGN KEY ("organization_id") REFERENCES "public"."organizations"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "fronts" ADD CONSTRAINT "fronts_owner_user_id_users_id_fk" FOREIGN KEY ("owner_user_id") REFERENCES "public"."users"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "fronts" ADD CONSTRAINT "fronts_author_user_id_users_id_fk" FOREIGN KEY ("author_user_id") REFERENCES "public"."users"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "fronts" ADD CONSTRAINT "fronts_approved_by_user_id_users_id_fk" FOREIGN KEY ("approved_by_user_id") REFERENCES "public"."users"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "google_identities" ADD CONSTRAINT "google_identities_user_id_users_id_fk" FOREIGN KEY ("user_id") REFERENCES "public"."users"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "item_invitations" ADD CONSTRAINT "item_invitations_user_id_users_id_fk" FOREIGN KEY ("user_id") REFERENCES "public"."users"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "item_role_assignments" ADD CONSTRAINT "item_role_assignments_user_id_users_id_fk" FOREIGN KEY ("user_id") REFERENCES "public"."users"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "item_templates" ADD CONSTRAINT "item_templates_personal_space_id_personal_spaces_id_fk" FOREIGN KEY ("personal_space_id") REFERENCES "public"."personal_spaces"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "item_templates" ADD CONSTRAINT "item_templates_author_user_id_users_id_fk" FOREIGN KEY ("author_user_id") REFERENCES "public"."users"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "notifications" ADD CONSTRAINT "notifications_reminder_id_reminders_id_fk" FOREIGN KEY ("reminder_id") REFERENCES "public"."reminders"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "owner_transfer_requests" ADD CONSTRAINT "owner_transfer_requests_current_owner_user_id_users_id_fk" FOREIGN KEY ("current_owner_user_id") REFERENCES "public"."users"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "owner_transfer_requests" ADD CONSTRAINT "owner_transfer_requests_proposed_owner_user_id_users_id_fk" FOREIGN KEY ("proposed_owner_user_id") REFERENCES "public"."users"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "owner_transfer_requests" ADD CONSTRAINT "owner_transfer_requests_requested_by_user_id_users_id_fk" FOREIGN KEY ("requested_by_user_id") REFERENCES "public"."users"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "personal_size_labels" ADD CONSTRAINT "personal_size_labels_personal_space_id_personal_spaces_id_fk" FOREIGN KEY ("personal_space_id") REFERENCES "public"."personal_spaces"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "personal_spaces" ADD CONSTRAINT "personal_spaces_owner_user_id_users_id_fk" FOREIGN KEY ("owner_user_id") REFERENCES "public"."users"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "phases" ADD CONSTRAINT "phases_process_id_processes_id_fk" FOREIGN KEY ("process_id") REFERENCES "public"."processes"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "phases" ADD CONSTRAINT "phases_personal_space_id_personal_spaces_id_fk" FOREIGN KEY ("personal_space_id") REFERENCES "public"."personal_spaces"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "phases" ADD CONSTRAINT "phases_owner_user_id_users_id_fk" FOREIGN KEY ("owner_user_id") REFERENCES "public"."users"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "phases" ADD CONSTRAINT "phases_author_user_id_users_id_fk" FOREIGN KEY ("author_user_id") REFERENCES "public"."users"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "phases" ADD CONSTRAINT "phases_approved_by_user_id_users_id_fk" FOREIGN KEY ("approved_by_user_id") REFERENCES "public"."users"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "processes" ADD CONSTRAINT "processes_personal_space_id_personal_spaces_id_fk" FOREIGN KEY ("personal_space_id") REFERENCES "public"."personal_spaces"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "processes" ADD CONSTRAINT "processes_author_user_id_users_id_fk" FOREIGN KEY ("author_user_id") REFERENCES "public"."users"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "processes" ADD CONSTRAINT "processes_approved_by_user_id_users_id_fk" FOREIGN KEY ("approved_by_user_id") REFERENCES "public"."users"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "products" ADD CONSTRAINT "products_personal_space_id_personal_spaces_id_fk" FOREIGN KEY ("personal_space_id") REFERENCES "public"."personal_spaces"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "products" ADD CONSTRAINT "products_author_user_id_users_id_fk" FOREIGN KEY ("author_user_id") REFERENCES "public"."users"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "products" ADD CONSTRAINT "products_approved_by_user_id_users_id_fk" FOREIGN KEY ("approved_by_user_id") REFERENCES "public"."users"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "projects" ADD CONSTRAINT "projects_personal_space_id_personal_spaces_id_fk" FOREIGN KEY ("personal_space_id") REFERENCES "public"."personal_spaces"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "projects" ADD CONSTRAINT "projects_author_user_id_users_id_fk" FOREIGN KEY ("author_user_id") REFERENCES "public"."users"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "projects" ADD CONSTRAINT "projects_approved_by_user_id_users_id_fk" FOREIGN KEY ("approved_by_user_id") REFERENCES "public"."users"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "recurrence_exceptions" ADD CONSTRAINT "recurrence_exceptions_series_id_recurrence_series_id_fk" FOREIGN KEY ("series_id") REFERENCES "public"."recurrence_series"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "recurrence_exceptions" ADD CONSTRAINT "recurrence_exceptions_occurrence_id_recurrence_occurrences_id_fk" FOREIGN KEY ("occurrence_id") REFERENCES "public"."recurrence_occurrences"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "recurrence_exceptions" ADD CONSTRAINT "recurrence_exceptions_created_by_user_id_users_id_fk" FOREIGN KEY ("created_by_user_id") REFERENCES "public"."users"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "recurrence_occurrences" ADD CONSTRAINT "recurrence_occurrences_series_id_recurrence_series_id_fk" FOREIGN KEY ("series_id") REFERENCES "public"."recurrence_series"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "recurrence_series" ADD CONSTRAINT "recurrence_series_personal_space_id_personal_spaces_id_fk" FOREIGN KEY ("personal_space_id") REFERENCES "public"."personal_spaces"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "recurrence_series" ADD CONSTRAINT "recurrence_series_organization_id_organizations_id_fk" FOREIGN KEY ("organization_id") REFERENCES "public"."organizations"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "recurrence_series" ADD CONSTRAINT "recurrence_series_owner_user_id_users_id_fk" FOREIGN KEY ("owner_user_id") REFERENCES "public"."users"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "recurrence_series" ADD CONSTRAINT "recurrence_series_author_user_id_users_id_fk" FOREIGN KEY ("author_user_id") REFERENCES "public"."users"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "reminders" ADD CONSTRAINT "reminders_personal_space_id_personal_spaces_id_fk" FOREIGN KEY ("personal_space_id") REFERENCES "public"."personal_spaces"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "tags" ADD CONSTRAINT "tags_personal_space_id_personal_spaces_id_fk" FOREIGN KEY ("personal_space_id") REFERENCES "public"."personal_spaces"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "task_list_tasks" ADD CONSTRAINT "task_list_tasks_list_id_task_lists_id_fk" FOREIGN KEY ("list_id") REFERENCES "public"."task_lists"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "task_list_tasks" ADD CONSTRAINT "task_list_tasks_task_id_tasks_id_fk" FOREIGN KEY ("task_id") REFERENCES "public"."tasks"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "task_lists" ADD CONSTRAINT "task_lists_personal_space_id_personal_spaces_id_fk" FOREIGN KEY ("personal_space_id") REFERENCES "public"."personal_spaces"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "task_lists" ADD CONSTRAINT "task_lists_author_user_id_users_id_fk" FOREIGN KEY ("author_user_id") REFERENCES "public"."users"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "tasks" ADD CONSTRAINT "tasks_personal_space_id_personal_spaces_id_fk" FOREIGN KEY ("personal_space_id") REFERENCES "public"."personal_spaces"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint

...
export const teams: DbTable = {
  ...
  columns: {
    ...
    description: {
      ...
      completeName: 'teams.team_description',
      type: 'string',
      length: 500,
      nullable: true
    },
...
export const activityDomains: DbTable = {
  name: 'activityDomains',
  columns: {
    id: {
      name: 'areaId',
      completeName: 'activityDomains.areaId',
      type: 'number',
      primary: true,
      nullable: false
    },
    name: {
      name: 'name',
      completeName: 'activityDomains.name',
      type: 'string',
      length: 255,
      nullable: false
    },
    organization: {
      name: 'orgId',
      completeName: 'activityDomains.orgId',
      type: 'number',
      nullable: true,
      foreignKey: {
        table: 'organizations',
    ...
    department: {
      name: 'deptId',
      completeName: 'activityDomains.deptId',
      type: 'number',
      nullable: true,
      foreignKey: {
        table: 'departments',
    ...
    team: {
      name: 'teamId',
      completeName: 'activityDomains.teamId',
      type: 'number',
      nullable: true,
      foreignKey: {
        table: 'teams',
    ...
    squad: {
      name: 'squadId',
      completeName: 'activityDomains.squadId',
      type: 'number',
      nullable: true,
      foreignKey: {
        table: 'squads',
    ...
    percentual: {
      name: 'percentual',
      completeName: 'activityDomains.percentual',
      type: 'number',
      nullable: false,
      default: 0
    }
